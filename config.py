...
ex = Experiment("RPT", save_git_info=False)
...
def cfg():
    ...
    ## dataset
    dataset = 'CMR'  # i.e. abdominal MRI - 'CHAOST2'; cardiac MRI - CMR
    ...
    # Network
    reload_model_path = './runs/PONET_train_CMR_cv0/1/snapshots/5000.pth'
