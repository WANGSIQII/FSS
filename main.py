...
def main(_run, _config, _log):
    ...
    for sub_epoch in range(n_sub_epochs):
        ...
        for _, sample in enumerate(train_loader):
            ...
            query_pred, periphery_loss, align_loss, mse_loss, qry_loss, contra_loss = model(support_images, support_fg_mask,
            ...
            loss = query_loss + 0.1 * periphery_loss + align_loss + 0.1 * mse_loss + 0.1 * contra_loss + qry_loss
